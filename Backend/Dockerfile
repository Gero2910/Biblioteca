...
WORKDIR /src
COPY ["BibliotecaBackend/BibliotecaBackend.csproj", "BibliotecaBackend/"]
RUN dotnet restore "BibliotecaBackend/BibliotecaBackend.csproj"
COPY . .
WORKDIR "/src/BibliotecaBackend"
